...
| **[svg-logo-designer](https://github.com/rknall/claude-skills)** | Professional SVG logo generation with multiple design concepts, layout variations (horizontal, vertical, icon-only), and color schemes |
